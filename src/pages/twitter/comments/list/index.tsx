...
import { apiGeListComments_FA, apiGeListComments_FB, apiGeListComments_TW } from '@/api/comments/api';
        ...
        return (
          <>
            <ul>
              ...
              <li>Link: <a target="_blank" href={item.postUrl}>{item.postUrl}</a></li>
            </ul>
          </>
        )
      }
