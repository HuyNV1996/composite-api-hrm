  ...
  return (
    <div className="trend" style={style}>
      <div className="trend-item">
        <span className="trend-item-label">{t({ id: 'app.dashboard.overview.wowChange' })}</span>
        <span className="trend-item-text">{wow}</span>
        <CaretUpIcon color="#f5222d" />
      </div>
      <div className="trend-item">
        <span className="trend-item-label">{t({ id: 'app.dashboard.overview.dodChange' })}</span>
...
const Overview: FC<{ loading: boolean }> = ({ loading }) => {
  ...
  return (
    <Row gutter={[12, 12]}>
      <ColCard
        loading={loading}
        metaName={t({ id: 'app.dashboard.overview.totalSales' })}
        metaCount="¥ 126,560"
        body={<Trend wow="12%" dod="12%" />}
        footer={<Field name={t({ id: 'app.dashboard.overview.dailySales' })} number="￥12,423" />}
      />
      <ColCard
        loading={loading}
        metaName={t({ id: 'app.dashboard.overview.visits' })}
        metaCount="8846"
        body={
          <ResponsiveContainer>
            <AreaChart data={data}>
        ...
        footer={<Field name={t({ id: 'app.dashboard.overview.dailySales' })} number="1234" />}
      />
      <ColCard
        loading={loading}
        metaName={t({ id: 'app.dashboard.overview.payments' })}
        metaCount="6560"
        body={
          <ResponsiveContainer>
            <BarChart data={data}>
        ...
        footer={<Field name={t({ id: 'app.dashboard.overview.conversionRate' })} number="60%" />}
      />
      <ColCard
        loading={loading}
        metaName={t({ id: 'app.dashboard.overview.operationalEffect' })}
        metaCount="8846"
